...
11. *(design done, Day 109, not built)* **Analyze Page Redesign** — full decision record and phased implementation plan at `docs/claude/design/ANALYZE_PAGE_REDESIGN_DECISIONS.md`; includes a real, unfixed bug (a hardcoded fake "half" position-size label). Build only when explicitly raised — freeze-independent, but still behind Priority #1.
