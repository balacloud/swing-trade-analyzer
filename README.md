...
10. *(parked, low priority)* **Dual/absolute momentum filter** — Antonacci's dual-momentum research (found Day 107) says a stock should also beat a risk-free/cash return in absolute terms, not just beat the market relatively. Backtest-tested clean but only excludes ~1% of the momentum engine's trades in practice — cheap to add once the freeze lifts, won't move results much.
