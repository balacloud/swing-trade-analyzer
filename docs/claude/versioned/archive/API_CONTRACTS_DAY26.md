...
> **Version:** Day 26 (January 12, 2026)
...
```json
{
  "strategies": [
    ...
    {"id": "best", "name": "Best Candidates", "description": "Large-cap Stage 2 stocks matching all scoring criteria (most likely BUY)"}
  ]
}
```

**Best Strategy Criteria (Day 26):**
- Exchange: NYSE, NASDAQ, AMEX only
- Market Cap: >= $10B (large-cap quality)
- Price > 50 SMA > 200 SMA (Stage 2 uptrend)
- RSI: 50-75 (bullish but not overbought)
- Relative Volume: >= 1.0x average
- Weekly change: >= 0%
- Monthly change: >= 0%

**Scanner Ticker Filters (Day 26):**
- Excludes: Preferred stocks (/), SPAC units (U), warrants (W/WS)
- Excludes: Preferred series (P/M/N/O/L suffix on 5+ char tickers)
- Excludes: Commodity ETFs (PHYS, PSLV, GLD, SLV, etc.)
...
| Day | Changes |
|-----|---------|
| Day 26 | Added "best" scanner strategy, scanner ticker filters, pullback guidance, S&R levels display |
...
*This file is versioned by day. Current version: DAY26*
*Previous version: API_CONTRACTS_DAY25.md*
